...
import lodei.core.plot_ratios as plotratios
...
def main():
    ...
    # --- plot_ratios ---------
    parser_plot_ratios = subparsers.add_parser(
        name="plotratios",
        help="Plots the editing signal versus log2(e/median(all e))",
        description="""'lodei plotratios'""",)

    parser_plot_ratios.add_argument(
        "-d", "--directory", type=str, required=True,
        help="The output directory generated by LoDEI that contains all 'window_XY.txt' files")
    ...
    parser_plot_ratios.set_defaults(func=plotratios.make_plot)
